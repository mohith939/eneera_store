        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
          {promises.map((promise, index) => (
            <div key={index} className="text-center group">
              <div className="w-20 h-20 mx-auto mb-6 rounded-full bg-background flex items-center justify-center shadow-soft group-hover:shadow-card transition-shadow duration-300">
                <promise.icon className="w-10 h-10 text-primary" strokeWidth={1.5} />
              </div>
